...
public class PartitionIntoKEqualSumSubsets {
    ...
    public static void main(String[] args) {
        PartitionIntoKEqualSumSubsets partitionIntoKEqualSumSubsets = new PartitionIntoKEqualSumSubsets();
        int arr[] = {2, 1, 4, 5, 3, 3};
        int N = arr.length;
        int K = 3;

        if (partitionIntoKEqualSumSubsets.canPartitionKSubsets(arr, K)){
